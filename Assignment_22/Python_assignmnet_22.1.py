'''
Q.1 Write a Python program to implement a class named Demo with the following specifications:
...
class Demo:
    ...
    def fun(self):
        print("Inside fun instance method: ",self.No1,self.No2)

    def gun(self):
        print("Inside gun instance method: ",self.No1,self.No2)
